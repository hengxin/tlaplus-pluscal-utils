...
\setboolean{shading}{true}
 ...
 {\MODULE} RelationUtils}\moduleRightDash\@xx{}%
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
Relation related operators.
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 5\hspace{1em}} {\LOCAL} {\INSTANCE}
 Naturals}%
 \@x{\makebox[0pt][r]{\scriptsize 6\hspace{1em}} {\LOCAL} {\INSTANCE}
 FiniteSets}%
 \@x{\makebox[0pt][r]{\scriptsize 7\hspace{1em}} {\LOCAL} {\INSTANCE}
 Sequences}%
 \@x{\makebox[0pt][r]{\scriptsize 8\hspace{1em}} {\LOCAL} {\INSTANCE}
 SequencesExt}%
 \@x{\makebox[0pt][r]{\scriptsize 9\hspace{1em}} {\LOCAL} {\INSTANCE}
 Functions}%
\@x{\makebox[0pt][r]{\scriptsize 10\hspace{1em}}}\midbar\@xx{}%
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
Basic definitions.
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 14\hspace{1em}} Dom ( R ) \.{\defeq} \{ a
 \.{:} {\langle} a ,\, b {\rangle} \.{\in} R \}}%
\@y{\@s{0}%
 Domain of \ensuremath{R
}}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 15\hspace{1em}} Ran ( R )\@s{3.32}
 \.{\defeq} \{ b\@s{0.64} \.{:} {\langle} a ,\, b {\rangle} \.{\in} R \}}%
\@y{\@s{0}%
 Range of \ensuremath{R
}}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 16\hspace{1em}} Support ( R ) \.{\defeq} Dom
 ( R ) \.{\cup} Ran ( R )}%
\@y{\@s{0}%
 Support of \ensuremath{R
}}%
\@xx{}%
...
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 21\hspace{1em}} Image ( R ,\, a ) \.{\defeq}
 \{ b \.{\in} Ran ( R ) \.{:} {\langle} a ,\, b {\rangle} \.{\in} R \}}%
 \@x{\makebox[0pt][r]{\scriptsize 22\hspace{1em}} LeftRestriction ( R ,\, a )
 \.{\defeq} \{ {\langle} a ,\, b {\rangle} \.{:} b\@s{8.85} \.{\in} Image ( R
 ,\, a ) \}}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 24\hspace{1em}} InverseRelation ( R
 )\@s{1.49} \.{\defeq} \{ {\langle} b ,\, a {\rangle} \.{:} {\langle} a ,\, b
 {\rangle} \.{\in} R \}}%
 \@x{\makebox[0pt][r]{\scriptsize 25\hspace{1em}} InverseImage ( R ,\, b )
 \.{\defeq} \{ a \.{\in} Dom ( R ) \.{:} {\langle} a ,\, b {\rangle} \.{\in}
 R \}}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 27\hspace{1em}} R \.{\,|\,} S \.{\defeq} R
 \.{\cap} ( S \.{\times} S )}%
\@y{\@s{0}%
 Restriction of \ensuremath{R} on \ensuremath{S
}}%
\@xx{}%
\@pvspace{8.0pt}%
\@x{\makebox[0pt][r]{\scriptsize 29\hspace{1em}} R \.{\stst} T \.{\defeq}}%
\@y{\@s{0}%
 Composition of \ensuremath{R} and \ensuremath{T
}}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 30\hspace{1em}}\@s{15.88} \.{\LET}
 SR\@s{4.90} \.{\defeq} Support ( R )}%
 \@x{\makebox[0pt][r]{\scriptsize 31\hspace{1em}}\@s{40.38} ST \.{\defeq}
 Support ( T )}%
 \@x{\makebox[0pt][r]{\scriptsize 32\hspace{1em}}\@s{15.88} \.{\IN}\@s{4.09}
 \{ {\langle} r ,\, t {\rangle} \.{\in} SR \.{\times} ST \.{:} \E\, s \.{\in}
 SR \.{\cap} ST \.{:} ( {\langle} r ,\, s {\rangle} \.{\in} R ) \.{\land} (
 {\langle} s ,\, t {\rangle} \.{\in} T ) \}}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 34\hspace{1em}} GT ( R ,\, a ) \.{\defeq} \{
 b\@s{0.64} \.{\in} Ran ( R )\@s{3.32} \.{:} {\langle} a ,\, b {\rangle}
 \.{\in} R \}}%
\@y{\@s{0}%
 \ensuremath{\.{\defeq} Image(R,\, a)
}}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 35\hspace{1em}} LT ( R ,\, b )\@s{2.87}
 \.{\defeq} \{ a \.{\in} Dom ( R ) \.{:} {\langle} a ,\, b {\rangle} \.{\in}
 R \}}%
\@y{\@s{0}%
 \ensuremath{\.{\defeq} InverseImage(R,\, b)
}}%
\@xx{}%
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
The following definition is from
 https:\ensuremath{\.{\slsl}github.com}/jameshfisher/tlaplus/blob/master/examples/\ensuremath{TransitiveClosure}/\ensuremath{TransitiveClosure.tla
} It also contains several other methods for computing \ensuremath{TC}.
\end{cpar}%
\end{lcom}%
\@x{\makebox[0pt][r]{\scriptsize 41\hspace{1em}} TC ( R ) \.{\defeq}}%
\@y{\@s{0}%
 Transitive closure of \ensuremath{R
}}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 42\hspace{1em}}\@s{27.33} \.{\LET} S
 \.{\defeq} Support ( R )}%
 \@x{\makebox[0pt][r]{\scriptsize 43\hspace{1em}}\@s{47.73} {\RECURSIVE} TCR (
 \_ )}%
 \@x{\makebox[0pt][r]{\scriptsize 44\hspace{1em}}\@s{51.83} TCR ( T )
 \.{\defeq} {\IF} T \.{=} \{ \}}%
\@x{\makebox[0pt][r]{\scriptsize 45\hspace{1em}}\@s{108.97} \.{\THEN} R}%
 \@x{\makebox[0pt][r]{\scriptsize 46\hspace{1em}}\@s{108.97} \.{\ELSE}
 \.{\LET} r \.{\defeq} {\CHOOSE} s \.{\in} T \.{:} {\TRUE}}%
 \@x{\makebox[0pt][r]{\scriptsize 47\hspace{1em}}\@s{164.78} RR \.{\defeq} TCR
 ( T \.{\,\backslash\,} \{ r \} )}%
 \@x{\makebox[0pt][r]{\scriptsize 48\hspace{1em}}\@s{140.28} \.{\IN}\@s{4.10}
 RR \.{\cup} \{ {\langle} s ,\, t {\rangle} \.{\in} S \.{\times} S \.{:}}%
 \@x{\makebox[0pt][r]{\scriptsize 49\hspace{1em}}\@s{199.76} {\langle} s ,\, r
 {\rangle} \.{\in} RR \.{\land} {\langle} r ,\, t {\rangle} \.{\in} RR \}}%
 \@x{\makebox[0pt][r]{\scriptsize 50\hspace{1em}}\@s{27.33} \.{\IN}\@s{4.09}
 TCR ( S )}%
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 Example: \ensuremath{SeqToRel({\langle}1,\, 2,\, 3{\rangle}) \.{=}
 \{{\langle}1,\, 2{\rangle},\, {\langle}1,\, 3{\rangle},\, {\langle}2,\,
 3{\rangle}\}
}%
\end{cpar}%
\end{lcom}%
\@x{\makebox[0pt][r]{\scriptsize 54\hspace{1em}} {\RECURSIVE} Seq2Rel ( \_ )}%
\@x{\makebox[0pt][r]{\scriptsize 55\hspace{1em}} Seq2Rel ( s ) \.{\defeq}}%
\@y{\@s{0}%
 Transform a sequence \ensuremath{s} into a strict total order relation
}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 56\hspace{1em}}\@s{16.4} {\IF} s \.{=}
 {\langle} {\rangle} \.{\THEN} \{ \}}%
 \@x{\makebox[0pt][r]{\scriptsize 57\hspace{1em}}\@s{16.4} \.{\ELSE} \.{\LET}
 h\@s{2.49} \.{\defeq} Head ( s )}%
 \@x{\makebox[0pt][r]{\scriptsize 58\hspace{1em}}\@s{72.21} t \.{\defeq} Tail
 ( s )}%
 \@x{\makebox[0pt][r]{\scriptsize 59\hspace{1em}}\@s{47.71} \.{\IN}\@s{4.09}
 \{ {\langle} h ,\, r {\rangle} \.{:} r \.{\in} Range ( t ) \} \.{\cup}
 Seq2Rel ( t )}%
...
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 64\hspace{1em}} IsReflexive ( R ,\, S )
 \.{\defeq} \forall\, a \.{\in} S \.{:} {\langle} a ,\, a {\rangle} \.{\in}
 R}%
 \@x{\makebox[0pt][r]{\scriptsize 65\hspace{1em}} IsIrreflexive ( R ,\, S )
 \.{\defeq} \forall\, a \.{\in} S \.{:} {\langle} a ,\, a {\rangle}
 \.{\notin} R}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 67\hspace{1em}} IsSymmetric ( R ,\, S )
 \.{\defeq} \A\, a ,\, b \.{\in} S \.{:} {\langle} a ,\, b {\rangle} \.{\in}
 R \.{\equiv} {\langle} b ,\, a {\rangle} \.{\in} R}%
 \@x{\makebox[0pt][r]{\scriptsize 68\hspace{1em}} IsAntisymmetric ( R ,\, S )
 \.{\defeq} \A\, a ,\, b \.{\in} S \.{:} {\langle} a ,\, b {\rangle} \.{\in}
 R \.{\land} {\langle} b ,\, a {\rangle} \.{\in} R \.{\implies} a \.{=} b}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 70\hspace{1em}} IsTransitive ( R ,\, S )
 \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 71\hspace{1em}}\@s{16.4} \forall\, a ,\, b
 ,\, c \.{\in} S \.{:} ( {\langle} a ,\, b {\rangle} \.{\in} R \.{\land}
 {\langle} b ,\, c {\rangle} \.{\in} R ) \.{\implies} {\langle} a ,\, c
 {\rangle} \.{\in} R}%
\@pvspace{8.0pt}%
\@x{\makebox[0pt][r]{\scriptsize 73\hspace{1em}}}%
\@y{\@s{0}%
 https:\ensuremath{\.{\slsl}en.wikipedia.org}/wiki/\ensuremath{Connected\_relation
}}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 74\hspace{1em}} IsTotal ( R ,\, S )
 \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 75\hspace{1em}}\@s{16.4} \forall\, a ,\, b
 \.{\in} S \.{:} {\langle} a ,\, b {\rangle} \.{\in} R \.{\lor} {\langle} b
 ,\, a {\rangle} \.{\in} R}%
\@pvspace{8.0pt}%
...
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 78\hspace{1em}} IsSemiconnex ( R ,\, S )
 \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 79\hspace{1em}}\@s{16.4} \forall\, a ,\, b
 \.{\in} S \.{:} a \.{\neq} b \.{\implies} ( {\langle} a ,\, b {\rangle}
 \.{\in} R \.{\lor} {\langle} b ,\, a {\rangle} \.{\in} R )}%
\@pvspace{8.0pt}%
\@x{\makebox[0pt][r]{\scriptsize 81\hspace{1em}}}%
\@y{\@s{0}%
 partial order: https:\ensuremath{\.{\slsl}en.wikipedia.org}/wiki/\ensuremath{Partially\_ordered\_set\.{\neq}Formal\_definition
}}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 82\hspace{1em}} IsPartialOrder ( R ,\, S )
 \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 83\hspace{1em}}\@s{16.4} \.{\land}
 IsReflexive ( R ,\, S )}%
 \@x{\makebox[0pt][r]{\scriptsize 84\hspace{1em}}\@s{16.4} \.{\land}
 IsAntisymmetric ( R ,\, S )}%
 \@x{\makebox[0pt][r]{\scriptsize 85\hspace{1em}}\@s{16.4} \.{\land}
 IsTransitive ( R ,\, S )}%
\@pvspace{8.0pt}%
\@x{\makebox[0pt][r]{\scriptsize 87\hspace{1em}}}%
\@y{\@s{0}%
 total order: https:\ensuremath{\.{\slsl}en.wikipedia.org}/wiki/\ensuremath{Total\_order
}}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 88\hspace{1em}} IsTotalOrder ( R ,\, S )
 \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 89\hspace{1em}}\@s{16.4} \.{\land}
 IsPartialOrder ( R ,\, S )}%
 \@x{\makebox[0pt][r]{\scriptsize 90\hspace{1em}}\@s{16.4} \.{\land} IsTotal (
 R ,\, S )}%
\@y{\@s{0}%
 Atually, \ensuremath{IsTotal(R,\, S) \.{\implies} IsReflexive(R,\, S)
}}%
\@xx{}%
\@pvspace{8.0pt}%
...
\@y{\@s{0}%
 ...
 https:\ensuremath{\.{\slsl}en.wikipedia.org}/wiki/\ensuremath{Partially\_ordered\_set\.{\neq}}Strict\_and\_non-strict\_partial\_orders
}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 93\hspace{1em}} IsStrictPartialOrder ( R ,\,
 S ) \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 94\hspace{1em}}\@s{16.4} \.{\land}
 IsIrreflexive ( R ,\, S )}%
 \@x{\makebox[0pt][r]{\scriptsize 95\hspace{1em}}\@s{16.4} \.{\land}
 IsTransitive ( R ,\, S )}%
\@pvspace{8.0pt}%
\@x{\makebox[0pt][r]{\scriptsize 97\hspace{1em}}}%
\@y{\@s{0}%
 strict total order:
 https:\ensuremath{\.{\slsl}en.wikipedia.org}/wiki/\ensuremath{Total\_order\.{\neq}Strict\_total\_order
}}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 98\hspace{1em}} IsStrictTotalOrder ( R ,\, S
 ) \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 99\hspace{1em}}\@s{16.4} \.{\land}
 IsIrreflexive ( R ,\, S )}%
 \@x{\makebox[0pt][r]{\scriptsize 100\hspace{1em}}\@s{16.4} \.{\land}
 IsTransitive ( R ,\, S )}%
 \@x{\makebox[0pt][r]{\scriptsize 101\hspace{1em}}\@s{16.4} \.{\land}
 IsSemiconnex ( R ,\, S )}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 103\hspace{1em}} Respect ( R ,\, T )
 \.{\defeq} T \.{\subseteq} R}%
\@y{\@s{0}%
 Does \ensuremath{R} respect \ensuremath{T}\.{?}
}%
\@xx{}%
...
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 108\hspace{1em}} Minimal ( R ,\, S )
 \.{\defeq}}%
\@y{\@s{0}%
 the set of minimal elements in relation \ensuremath{R} on the set
 \ensuremath{S
}}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 109\hspace{1em}}\@s{16.4} \{ m \.{\in} S
 \.{:} {\lnot} \E\, a \.{\in} Dom ( R ) \.{:} {\langle} a ,\, m {\rangle}
 \.{\in} R \}}%
 \@x{\makebox[0pt][r]{\scriptsize 110\hspace{1em}} Maximal ( R ,\, S )
 \.{\defeq}}%
\@y{\@s{0}%
 the set of maximal elements in relation \ensuremath{R} on the set
 \ensuremath{S
}}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 111\hspace{1em}}\@s{16.4} \{ m \.{\in} S
 \.{:} {\lnot} \E\, b \.{\in} Ran ( R ) \.{:} {\langle} m ,\, b {\rangle}
 \.{\in} R \}}%
\@x{\makebox[0pt][r]{\scriptsize 112\hspace{1em}}}\midbar\@xx{}%
\begin{lcom}{5.0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
A variant of \ensuremath{Kahn}\mbox{'}s algorithm for topological sorting
\end{cpar}%
\vshade{5.0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
See https:\ensuremath{\.{\slsl}en.wikipedia.org}/wiki/\ensuremath{Topological\_sorting\.{\neq}Kahn}\mbox{'}s\_algorithm
\end{cpar}%
\end{lcom}%
\@x{\makebox[0pt][r]{\scriptsize 118\hspace{1em}} Cyclic ( R ) \.{\defeq}}%
\@y{\@s{0}%
 Is \ensuremath{R} cyclic\.{?}
}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 119\hspace{1em}}\@s{16.4} \.{\LET}
 {\RECURSIVE} CyclicUtil ( \_ ,\, \_ )}%
 \@x{\makebox[0pt][r]{\scriptsize 120\hspace{1em}}\@s{40.89} CyclicUtil ( rel
 ,\, set ) \.{\defeq}}%
\@y{\@s{0}%
 remaining relation; set: remaining set
}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 121\hspace{1em}}\@s{57.29} {\IF} set \.{=}
 \{ \} \.{\THEN} {\FALSE}}%
 \@x{\makebox[0pt][r]{\scriptsize 122\hspace{1em}}\@s{57.29} \.{\ELSE}
 \.{\LET} mins \.{\defeq} Minimal ( rel ,\, set )}%
 \@x{\makebox[0pt][r]{\scriptsize 123\hspace{1em}}\@s{88.61} \.{\IN} {\IF}
 mins \.{=} \{ \} \.{\THEN} {\TRUE}}%
 \@x{\makebox[0pt][r]{\scriptsize 124\hspace{1em}}\@s{109.01} \.{\ELSE}
 \.{\LET} m \.{\defeq} {\CHOOSE} x \.{\in} mins \.{:} {\TRUE}}%
 \@x{\makebox[0pt][r]{\scriptsize 125\hspace{1em}}\@s{140.32} \.{\IN}
 CyclicUtil ( rel \.{\,\backslash\,} LeftRestriction ( R ,\, m ) ,\, set
 \.{\,\backslash\,} \{ m \} )}%
 \@x{\makebox[0pt][r]{\scriptsize 126\hspace{1em}}\@s{16.4} \.{\IN}\@s{4.09}
 CyclicUtil ( R ,\, Support ( R ) )}%
\@x{\makebox[0pt][r]{\scriptsize 127\hspace{1em}}}\midbar\@xx{}%
\begin{lcom}{5.0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
\ensuremath{Kahn}\mbox{'}s algorithm for topological sorting.
\end{cpar}%
\vshade{5.0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
See https:\ensuremath{\.{\slsl}en.wikipedia.org}/wiki/\ensuremath{Topological\_sorting\.{\neq}Kahn}\mbox{'}s\_algorithm
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 133\hspace{1em}} AnyLinearExtension ( R ,\,
 S ) \.{\defeq}}%
\@y{\@s{0}%
 return an arbitrary linear extension of \ensuremath{R} on the set
 \ensuremath{S
}}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 134\hspace{1em}}\@s{16.4} \.{\LET}
 {\RECURSIVE} LinearExtensionUtil ( \_ ,\, \_ )}%
 \@x{\makebox[0pt][r]{\scriptsize 135\hspace{1em}}\@s{40.89}
 LinearExtensionUtil ( rel ,\, set ) \.{\defeq}}%
\@y{\@s{0}%
 \ensuremath{rel}: remaining relation; set: remaining set
}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 136\hspace{1em}}\@s{57.29} {\IF} set \.{=}
 \{ \} \.{\THEN} {\langle} {\rangle}}%
 \@x{\makebox[0pt][r]{\scriptsize 137\hspace{1em}}\@s{57.29} \.{\ELSE}
 \.{\LET} m \.{\defeq} {\CHOOSE} x \.{\in} Minimal ( rel ,\, set ) \.{:}
 {\TRUE}}%
 \@x{\makebox[0pt][r]{\scriptsize 138\hspace{1em}}\@s{88.61} \.{\IN} {\langle}
 m {\rangle} \.{\circ} LinearExtensionUtil ( rel \.{\,\backslash\,}
 LeftRestriction ( R ,\, m ) ,\, set \.{\,\backslash\,} \{ m \} )}%
 \@x{\makebox[0pt][r]{\scriptsize 139\hspace{1em}}\@s{16.4} \.{\IN}\@s{4.09}
 LinearExtensionUtil ( R ,\, S )}%
\@pvspace{8.0pt}%
\begin{lcom}{5.0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
A variant of \ensuremath{Kahn}\mbox{'}s algorithm for topological sorting
...
\vshade{5.0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 For some TLA+ issue, see
 https:\ensuremath{\.{\slsl}groups.google.com}/g/tlaplus/\ensuremath{c}/\ensuremath{mtyEmqhlRVg
}%
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 148\hspace{1em}} AllLinearExtensions ( R ,\,
 S ) \.{\defeq}}%
\@y{\@s{0}%
 return all possible linear extensions of \ensuremath{R} on the set
 \ensuremath{S
}}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 149\hspace{1em}}\@s{16.4} \.{\LET}
 {\RECURSIVE} LinearExtensionsUtil ( \_ ,\, \_ )}%
 \@x{\makebox[0pt][r]{\scriptsize 150\hspace{1em}}\@s{40.89}
 LinearExtensionsUtil ( rel ,\, set ) \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 151\hspace{1em}}\@s{57.29} {\IF} set \.{=}
 \{ \} \.{\THEN} \{ {\langle} {\rangle} \}}%
 \@x{\makebox[0pt][r]{\scriptsize 152\hspace{1em}}\@s{57.29} \.{\ELSE}
 \.{\LET} Extend ( m ) \.{\defeq} \{ {\langle} m {\rangle} \.{\circ} l \.{:}}%
\@y{\@s{0}%
 extend recursively by the minimal element \ensuremath{m
}}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 153\hspace{1em}}\@s{121.31} l \.{\in}
 LinearExtensionsUtil ( rel \.{\,\backslash\,} LeftRestriction ( R ,\, m )
 ,\, set \.{\,\backslash\,} \{ m \} ) \}}%
 \@x{\makebox[0pt][r]{\scriptsize 154\hspace{1em}}\@s{88.61} \.{\IN} {\UNION}
 \{ Extend ( m ) \.{:} m \.{\in} Minimal ( rel ,\, set ) \}}%
\@y{\@s{0}%
 for each minimal element
}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 155\hspace{1em}}\@s{16.4} \.{\IN}\@s{4.09}
 LinearExtensionsUtil ( R ,\, S )}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 157\hspace{1em}} LinearExtensions ( R ,\, S
 ) \.{\defeq}}%
\@y{\@s{0}%
 return the set of all possible linear extensions of \ensuremath{R} on the
 set \ensuremath{S
}}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 158\hspace{1em}}\@s{16.4} \{ l \.{\in}
 TupleOf ( S ,\, Cardinality ( S ) ) \.{:} Respect ( Seq2Rel ( l ) ,\, R )
 \}}%
...
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 163\hspace{1em}} rel0\@s{1.06} \.{\defeq} \{
 \}}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 165\hspace{1em}} set1 \.{\defeq} \{ 2 ,\, 3
 ,\, 5 ,\, 7 ,\, 8 ,\, 9 ,\, 10 ,\, 11 \}}%
\@x{\makebox[0pt][r]{\scriptsize 166\hspace{1em}} rel1\@s{1.06} \.{\defeq}}%
\@y{\@s{0}%
 from https:\ensuremath{\.{\slsl}en.wikipedia.org}/wiki/\ensuremath{Topological\_sorting
}}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 167\hspace{1em}}\@s{16.4} \{ {\langle} 3 ,\,
 8 {\rangle} ,\, {\langle} 3 ,\, 10 {\rangle} ,\, {\langle} 5 ,\, 11
 {\rangle} ,\, {\langle} 7 ,\, 8 {\rangle} ,\, {\langle} 7 ,\, 11 {\rangle}
 ,\,}%
 \@x{\makebox[0pt][r]{\scriptsize 168\hspace{1em}}\@s{21.40} {\langle} 8 ,\, 9
 {\rangle} ,\, {\langle} 11 ,\, 2 {\rangle} ,\, {\langle} 11 ,\, 9 {\rangle}
 ,\, {\langle} 11 ,\, 10 {\rangle} \}}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 170\hspace{1em}} set2 \.{\defeq} 0
 \.{\dotdot} 5}%
\@x{\makebox[0pt][r]{\scriptsize 171\hspace{1em}} rel2\@s{1.06} \.{\defeq}}%
\@y{\@s{0}%
 from https:\ensuremath{\.{\slsl}www.geeksforgeeks.org}/topological-sorting/
}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 172\hspace{1em}}\@s{16.4} \{ {\langle} 2 ,\,
 3 {\rangle} ,\, {\langle} 3 ,\, 1 {\rangle} ,\, {\langle} 4 ,\, 0 {\rangle}
 ,\, {\langle} 4 ,\, 1 {\rangle} ,\, {\langle} 5 ,\, 0 {\rangle} ,\,
 {\langle} 5 ,\, 2 {\rangle} \}}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 174\hspace{1em}} set3 \.{\defeq} 1
 \.{\dotdot} 6}%
\@x{\makebox[0pt][r]{\scriptsize 175\hspace{1em}} rel3\@s{1.06} \.{\defeq}}%
\@y{\@s{0}%
 from https:\ensuremath{\.{\slsl}leetcode.com}/discuss/general-discussion/1078072/introduction-to-topological-sort
}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 176\hspace{1em}}\@s{16.4} \{ {\langle} 1 ,\,
 2 {\rangle} ,\, {\langle} 1 ,\, 4 {\rangle} ,\, {\langle} 2 ,\, 3 {\rangle}
 ,\, {\langle} 4 ,\, 2 {\rangle} ,\, {\langle} 4 ,\, 5 {\rangle} ,\,
 {\langle} 4 ,\, 6 {\rangle} ,\, {\langle} 5 ,\, 6 {\rangle} \}}%
\@pvspace{8.0pt}%
\@x{\makebox[0pt][r]{\scriptsize 178\hspace{1em}} set4 \.{\defeq} \{ 1 \}}%
 \@x{\makebox[0pt][r]{\scriptsize 179\hspace{1em}} rel4\@s{1.06} \.{\defeq} \{
 {\langle} 1 ,\, 1 {\rangle} \}}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 181\hspace{1em}} set5 \.{\defeq} \{ 1 ,\, 2
 \}}%
 \@x{\makebox[0pt][r]{\scriptsize 182\hspace{1em}} rel5\@s{1.06} \.{\defeq} \{
 {\langle} 1 ,\, 2 {\rangle} ,\, {\langle} 2 ,\, 1 {\rangle} \}}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 184\hspace{1em}} set6 \.{\defeq} 1
 \.{\dotdot} 4}%
 \@x{\makebox[0pt][r]{\scriptsize 185\hspace{1em}} rel6\@s{1.06} \.{\defeq} \{
 {\langle} 1 ,\, 2 {\rangle} ,\, {\langle} 2 ,\, 3 {\rangle} ,\, {\langle} 3
 ,\, 4 {\rangle} ,\, {\langle} 4 ,\, 1 {\rangle} \}}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 187\hspace{1em}} set7 \.{\defeq} 1
 \.{\dotdot} 4}%
 \@x{\makebox[0pt][r]{\scriptsize 188\hspace{1em}} rel7\@s{1.06} \.{\defeq} \{
 {\langle} 1 ,\, 2 {\rangle} ,\, {\langle} 2 ,\, 3 {\rangle} ,\, {\langle} 3
 ,\, 4 {\rangle} \}}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 190\hspace{1em}} set8 \.{\defeq} 1
 \.{\dotdot} 3}%
 \@x{\makebox[0pt][r]{\scriptsize 191\hspace{1em}} rel8\@s{1.06} \.{\defeq} \{
 {\langle} 1 ,\, 2 {\rangle} ,\, {\langle} 1 ,\, 3 {\rangle} ,\, {\langle} 2
 ,\, 3 {\rangle} \}}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 193\hspace{1em}} all \.{\defeq} \{ rel0 ,\,
 rel1 ,\, rel2 ,\, rel3 ,\, rel4 ,\, rel5 ,\, rel6 ,\, rel7 \}}%
\@x{\makebox[0pt][r]{\scriptsize 194\hspace{1em}}}\midbar\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 195\hspace{1em}} LETest \.{\defeq}}%
\@y{\@s{0}%
 test of linear extensions
}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 196\hspace{1em}}\@s{16.4} \.{\land}\@s{4.89}
 AllLinearExtensions ( rel1 ,\, set1 ) \.{=} LinearExtensions ( rel1 ,\, set1
 )}%
 \@x{\makebox[0pt][r]{\scriptsize 197\hspace{1em}}\@s{16.4} \.{\land}\@s{4.89}
 AllLinearExtensions ( rel2 ,\, set2 ) \.{=} LinearExtensions ( rel2 ,\, set2
 )}%
 \@x{\makebox[0pt][r]{\scriptsize 198\hspace{1em}}\@s{16.4} \.{\land}\@s{4.89}
 AllLinearExtensions ( rel3 ,\, set3 ) \.{=} LinearExtensions ( rel3 ,\, set3
 )}%
\@x{\makebox[0pt][r]{\scriptsize 199\hspace{1em}}}\midbar\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 200\hspace{1em}} CyclicTest \.{\defeq}}%
\@y{\@s{0}%
 test of \ensuremath{Cyclic(R)
}}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 201\hspace{1em}}\@s{16.4} \.{\LET} cyclic
 \.{\defeq} \{ rel4 ,\, rel5 ,\, rel6 \}}%
 \@x{\makebox[0pt][r]{\scriptsize 202\hspace{1em}}\@s{16.4} \.{\IN} \.{\land}
 \A\, c \.{\in} cyclic \.{:} Cyclic ( c )}%
 \@x{\makebox[0pt][r]{\scriptsize 203\hspace{1em}}\@s{36.79} \.{\land} \A\, c
 \.{\in} all \.{\,\backslash\,} cyclic \.{:} {\lnot} Cyclic ( c )}%
\@x{\makebox[0pt][r]{\scriptsize 204\hspace{1em}}}\midbar\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 205\hspace{1em}} IsStrictTotalOrderTest
 \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 206\hspace{1em}}\@s{16.4} \.{\land} {\lnot}
 IsStrictTotalOrder ( rel7 ,\, set7 )}%
 \@x{\makebox[0pt][r]{\scriptsize 207\hspace{1em}}\@s{16.4} \.{\land}
 IsStrictTotalOrder ( rel8 ,\, set8 )}%
\@x{\makebox[0pt][r]{\scriptsize 208\hspace{1em}}}\midbar\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 209\hspace{1em}} {\VARIABLES} x}%
\@x{\makebox[0pt][r]{\scriptsize 210\hspace{1em}}}\bottombar\@xx{}%
\setboolean{shading}{false}
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 ...
 \ensuremath{Apr} 22 14:56:23 \ensuremath{CST} 2021 by \ensuremath{hengxin
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* Created \ensuremath{Tue} \ensuremath{Sep} 18
 19:16:04 \ensuremath{CST} 2018 by \ensuremath{hengxin
}%
\end{cpar}%
\end{lcom}%
\end{document}
