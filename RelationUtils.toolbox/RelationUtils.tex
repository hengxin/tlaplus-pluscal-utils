...
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 10\hspace{1em}} Dom ( R ) \.{\defeq} \{ a
 \.{:} {\langle} a ,\, b {\rangle} \.{\in} R \}}%
\@y{\@s{0}%
 Domain of \ensuremath{R
}}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 11\hspace{1em}} Ran ( R )\@s{3.32}
 \.{\defeq} \{ b\@s{0.64} \.{:} {\langle} a ,\, b {\rangle} \.{\in} R \}}%
\@y{\@s{0}%
 Range of \ensuremath{R
}}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 12\hspace{1em}} Support ( R ) \.{\defeq} Dom
 ( R ) \.{\cup} Ran ( R )}%
\@y{\@s{0}%
...
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 16\hspace{1em}} Inverse ( R ) \.{\defeq} \{
 {\langle} b ,\, a {\rangle} \.{:} {\langle} a ,\, b {\rangle} \.{\in} R \}}%
\@y{\@s{0}%
 Inverse of \ensuremath{R
}}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 17\hspace{1em}} R \.{\,|\,} S \.{\defeq} R
 \.{\cap} S \.{\times} S}%
\@y{\@s{0}%
...
\@xx{}%
\@pvspace{8.0pt}%
\@x{\makebox[0pt][r]{\scriptsize 19\hspace{1em}} R \.{\stst} T \.{\defeq}}%
\@y{\@s{0}%
 Composition of \ensuremath{R} and \ensuremath{T
}}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 20\hspace{1em}}\@s{15.88} \.{\LET}
 SR\@s{4.90} \.{\defeq} Support ( R )}%
 \@x{\makebox[0pt][r]{\scriptsize 21\hspace{1em}}\@s{40.38} ST \.{\defeq}
 Support ( T )}%
 \@x{\makebox[0pt][r]{\scriptsize 22\hspace{1em}}\@s{15.88} \.{\IN}\@s{4.09}
 \{ {\langle} r ,\, t {\rangle} \.{\in} SR \.{\times} ST \.{:} \E\, s \.{\in}
 SR \.{\cap} ST \.{:} ( {\langle} r ,\, s {\rangle} \.{\in} R ) \.{\land} (
 {\langle} s ,\, t {\rangle} \.{\in} T ) \}}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 24\hspace{1em}} GT ( R ,\, a ) \.{\defeq} \{
 b\@s{0.64} \.{\in} Ran ( R )\@s{3.32} \.{:} {\langle} a ,\, b {\rangle}
 \.{\in} R \}}%
 \@x{\makebox[0pt][r]{\scriptsize 25\hspace{1em}} LT ( R ,\, b )\@s{2.87}
...
\end{cpar}%
\end{lcom}%
\@x{\makebox[0pt][r]{\scriptsize 31\hspace{1em}} TC ( R ) \.{\defeq}}%
\@y{\@s{0}%
 Transitive closure of \ensuremath{R
}}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 32\hspace{1em}}\@s{27.33} \.{\LET} S
 \.{\defeq} Support ( R )}%
 \@x{\makebox[0pt][r]{\scriptsize 33\hspace{1em}}\@s{47.73} {\RECURSIVE} TCR (
 \_ )}%
 \@x{\makebox[0pt][r]{\scriptsize 34\hspace{1em}}\@s{51.83} TCR ( T )
 \.{\defeq} {\IF} T \.{=} \{ \}}%
\@x{\makebox[0pt][r]{\scriptsize 35\hspace{1em}}\@s{108.97} \.{\THEN} R}%
 \@x{\makebox[0pt][r]{\scriptsize 36\hspace{1em}}\@s{108.97} \.{\ELSE}
 \.{\LET} r \.{\defeq} {\CHOOSE} s \.{\in} T \.{:} {\TRUE}}%
 \@x{\makebox[0pt][r]{\scriptsize 37\hspace{1em}}\@s{164.78} RR \.{\defeq} TCR
 ( T \.{\,\backslash\,} \{ r \} )}%
 \@x{\makebox[0pt][r]{\scriptsize 38\hspace{1em}}\@s{140.28} \.{\IN}\@s{4.10}
 RR \.{\cup} \{ {\langle} s ,\, t {\rangle} \.{\in} S \.{\times} S \.{:}}%
 \@x{\makebox[0pt][r]{\scriptsize 39\hspace{1em}}\@s{199.76} {\langle} s ,\, r
 {\rangle} \.{\in} RR \.{\land} {\langle} r ,\, t {\rangle} \.{\in} RR \}}%
 \@x{\makebox[0pt][r]{\scriptsize 40\hspace{1em}}\@s{27.33} \.{\IN}\@s{4.09}
 TCR ( S )}%
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
...
\end{cpar}%
\end{lcom}%
\@x{\makebox[0pt][r]{\scriptsize 44\hspace{1em}} SeqToRel ( s ) \.{\defeq}}%
\@y{\@s{0}%
 Transform a (total order) sequence to a relation
}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 45\hspace{1em}}\@s{16.4} \.{\LET}\@s{3.98}
 {\RECURSIVE} SeqRel ( \_ ,\, \_ )}%
 \@x{\makebox[0pt][r]{\scriptsize 46\hspace{1em}}\@s{40.89} SeqRel ( seq ,\,
 rel ) \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 47\hspace{1em}}\@s{57.29} {\IF} Len ( seq )
 \.{\leq} 1}%
\@x{\makebox[0pt][r]{\scriptsize 48\hspace{1em}}\@s{57.29} \.{\THEN} rel}%
 \@x{\makebox[0pt][r]{\scriptsize 49\hspace{1em}}\@s{57.29} \.{\ELSE} \.{\LET}
 h\@s{2.49} \.{\defeq} Head ( seq )}%
 \@x{\makebox[0pt][r]{\scriptsize 50\hspace{1em}}\@s{113.11} t \.{\defeq} Tail
 ( seq )}%
 \@x{\makebox[0pt][r]{\scriptsize 51\hspace{1em}}\@s{88.61} \.{\IN}\@s{4.09}
 SeqRel ( t ,\, rel \.{\cup} \{ {\langle} h ,\, r {\rangle} \.{:} r \.{\in}
 Range ( t ) \} )}%
 \@x{\makebox[0pt][r]{\scriptsize 52\hspace{1em}}\@s{16.4} \.{\IN}\@s{4.09}
 SeqRel ( s ,\, \{ \} )}%
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
Basic properties.
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 56\hspace{1em}} Reflexive ( S ,\, R )
 \.{\defeq} \forall\, a \.{\in} S \.{:} {\langle} a ,\, a {\rangle} \.{\in}
 R}%
\@y{\@s{0}%
 is \ensuremath{R} reflexive\.{?}
}%
\@xx{}%
\@pvspace{8.0pt}%
\@x{\makebox[0pt][r]{\scriptsize 58\hspace{1em}} Transitive ( R ) \.{\defeq}}%
\@y{\@s{0}%
 Is \ensuremath{R} transitive\.{?}
}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 59\hspace{1em}}\@s{16.4} \.{\LET} S
 \.{\defeq} Support ( R )}%
 \@x{\makebox[0pt][r]{\scriptsize 60\hspace{1em}}\@s{16.4} \.{\IN} \forall\, a
 ,\, b ,\, c \.{\in} S \.{:} ( {\langle} a ,\, b {\rangle} \.{\in} R
 \.{\land} {\langle} b ,\, c {\rangle} \.{\in} R ) \.{\implies} {\langle} a
 ,\, c {\rangle} \.{\in} R}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 62\hspace{1em}} Respect ( R ,\, T )
 \.{\defeq} T \.{\subseteq} R}%
\@y{\@s{0}%
 Does \ensuremath{R} respect \ensuremath{T}\.{?}
}%
\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 63\hspace{1em}}}\bottombar\@xx{}%
\setboolean{shading}{false}
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
...
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* Last modified Sat \ensuremath{Jan} 25
 15:55:08 \ensuremath{CST} 2020 by \ensuremath{hengxin
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
