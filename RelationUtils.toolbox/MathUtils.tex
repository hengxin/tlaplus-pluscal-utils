...
\setboolean{shading}{true}
 ...
 {\MODULE} AdditionalMathOperators}\moduleRightDash\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 2\hspace{1em}} {\EXTENDS} Naturals}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 4\hspace{1em}} PosInt \.{\defeq} Nat
 \.{\,\backslash\,} \{ 0 \}}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 6\hspace{1em}} Min ( x ,\, y )\@s{2.25}
 \.{\defeq} {\IF} x \.{\leq} y \.{\THEN} x \.{\ELSE} y}%
 \@x{\makebox[0pt][r]{\scriptsize 7\hspace{1em}} Max ( x ,\, y )\@s{0.75}
 \.{\defeq} {\IF} x \.{\leq} y \.{\THEN} y\@s{0.10} \.{\ELSE} x}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 9\hspace{1em}} SetMin ( s )\@s{1.49}
 \.{\defeq} {\CHOOSE} a \.{\in} S \.{:} \A\, b \.{\in} S \.{:} a \.{\leq} b}%
 \@x{\makebox[0pt][r]{\scriptsize 10\hspace{1em}} SetMax ( s ) \.{\defeq}
 {\CHOOSE} a \.{\in} S \.{:} \A\, b \.{\in} S \.{:} b\@s{0.64} \.{\leq} a}%
\@x{\makebox[0pt][r]{\scriptsize 11\hspace{1em}}}\bottombar\@xx{}%
\setboolean{shading}{false}
\begin{lcom}{0}%
...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 ...
 17:05:44 \ensuremath{CST} 2020 by \ensuremath{hengxin
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* Created \ensuremath{Fri} \ensuremath{Jul} 06
 13:08:50 \ensuremath{CST} 2018 by \ensuremath{hengxin
}%
\end{cpar}%
\end{lcom}%
\end{document}
